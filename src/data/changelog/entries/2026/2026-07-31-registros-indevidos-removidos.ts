...
const entrada: ChangelogEntry = {
  ...
  body: [
    ...
    'Como id é endereço público, cada registro retirado está listado, com o motivo e o número anterior — mas em dois lugares diferentes, porque são duas coisas diferentes. As quatro contravenções revogadas vão para o acervo histórico, que reúne o que já foi crime no Brasil. Os demais vão para a errata dos dados abertos: não deixaram de ser crime, nunca foram, e um histórico dos nossos enganos não é material de pesquisa sobre a lei.',
  ],
  tipo: 'correcao',
