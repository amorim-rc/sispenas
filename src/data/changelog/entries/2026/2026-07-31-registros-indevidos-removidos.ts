...
const entrada: ChangelogEntry = {
  ...
  body: [
    ...
    'Como id é endereço público, cada registro retirado está listado no acervo histórico, com o motivo e o número anterior. Quem chegar por um link antigo encontra ali o que houve.',
  ],
  tipo: 'correcao',
